...
if __name__ == "__main__":
    ...
    s10 = send_dust.sensor(pi, 4)  # GPIO 4 - Seosor Pin 4 (PM10)
    s25 = send_dust.sensor(pi, 2)  # GPIO 2 - Seosor Pin 2 (PM25)
    ...
    while True:
        ...
        g10, interval10, r10, PM10count, total_interrupt_count10, wrong_level_count10 = s10.read()  # 이게 중요!
